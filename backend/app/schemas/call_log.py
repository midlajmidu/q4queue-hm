...
class ParentOrgBranchCallingStat(BaseModel):
    branch_id: uuid.UUID
    branch_name: str
    branch_slug: str
...
class ParentOrgCallingOverviewResponse(BaseModel):
    total_calls: int = 0
    connection_rate: float = 0.0
    total_billable_minutes: int = 0
    total_amount: float = 0.0
    ...
    currency: str = "₹"
    branches: List[ParentOrgBranchCallingStat] = []

class ParentOrgCallLogItem(CallLogRead):
    branch_name: str
    branch_slug: str
