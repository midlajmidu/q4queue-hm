...
DEFAULT_TEMPLATES = [
    {
        ...
        "body_text": (
            "Hello {{1}}! 👋\n\n"
            "You have successfully joined the queue at *{{2}}*.\n\n"
            "🎫 *Token:* {{3}}\n"
            "📍 *Current Position:* {{4}}\n\n"
...
async def get_rendered_template(
    ...
    """
    Return (template_name, rendered_body, error) for an event type.
    ...
    return template.template_name, rendered, None
