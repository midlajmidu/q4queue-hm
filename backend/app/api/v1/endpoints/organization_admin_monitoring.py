...
async def get_analytics(
    ...
    if not analytics_data:
        ...
        return AnalyticsResponse(
            ...
            volume_trend=[], branch_ranking=[], queue_analytics=[], peak_traffic=[], staff_performance=[], pax_analytics=[], pax_summary=None, 
            insights=["💡 AI is currently collecting data. Strategic insights will be generated automatically as queue activity begins."]
        )
