...
async def get_analytics(
    ...
    if not analytics_data:
        ...
        return AnalyticsResponse(
            ...
            volume_trend=[], branch_ranking=[], queue_analytics=[], peak_traffic=[], staff_performance=[], pax_analytics=[], pax_summary=None, insights=[]
        )
...
async def export_analytics(
    ...
    response.headers["Content-Disposition"] = "attachment; filename=cross_branch_analytics.xlsx"
    return response
