...
const QueueCard = React.memo(function QueueCard({ queue, onToggled }: Props) {
    ...
    return (
        <div className={`bg-white dark:bg-slate-900 rounded-xl border ${isActive ? 'border-slate-200/80 dark:border-white/10' : 'border-slate-200/60 dark:border-white/10 opacity-75'} p-5 shadow-sm relative overflow-hidden flex flex-col justify-between group transition-all`}>
            ...
            {isActive ? (
                <Ticket className="absolute -bottom-10 -right-6 w-56 h-56 text-slate-900 dark:text-white opacity-[0.06] dark:opacity-[0.04] -rotate-45 pointer-events-none select-none z-0 transition-all duration-700 ease-in-out group-hover:scale-110 group-hover:rotate-0" />
            ) : (
                <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    ...
                    className="absolute -bottom-10 -right-6 w-56 h-56 text-slate-900 dark:text-white opacity-[0.08] dark:opacity-[0.04] -rotate-45 pointer-events-none select-none z-0 transition-all duration-700 ease-in-out group-hover:scale-110 group-hover:rotate-0"
                >
