...
export default function OrganizationAdminChangePasswordPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Update local storage with the new JWT token
            ...
            <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
                ...
                <div className="absolute inset-0 opacity-[0.15]">
                    <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
                        <defs>
                            <pattern id="waves-change-pwd" width="200" height="200" patternUnits="userSpaceOnUse" patternTransform="scale(2) rotate(15)">
                        ...
                        <rect width="100%" height="100%" fill="url(#waves-change-pwd)" />
                    </svg>
                </div>
            </div>
