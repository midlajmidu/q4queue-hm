            ...
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8 flex flex-col gap-4 md:gap-6">
                ...
                <div className="p-4 md:py-4 md:px-6 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 rounded-xl shadow-sm ring-1 ring-slate-900/5 w-full">
                    <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 xl:gap-5 w-full">
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-4 w-full xl:w-auto">
                            {/* Date Navigator Pill */}
                            <div className={`flex items-center justify-between md:justify-start gap-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/10 rounded-lg shadow-sm p-1 w-full md:w-auto ${dateNavLoading ? 'opacity-60 pointer-events-none' : ''}`}>
                                <button
                                    onClick={handlePrevDay}
                                    className="p-2 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-md text-slate-500 dark:text-slate-400 transition-colors"
                                ...
                                <button
                                    ...
                                    className="flex flex-1 md:flex-none justify-center items-center gap-2 px-3 py-1.5 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-md cursor-pointer text-sm font-bold text-slate-900 dark:text-white transition-colors"
                                >
                            ...
                            <div className="flex items-center gap-2 flex-wrap text-xs font-medium text-slate-400 w-full md:w-auto">
                                {session && (
                                    <span className="text-indigo-500 dark:text-indigo-400 font-semibold">{formatWeekday(session.session_date)}</span>
                                )}
                ...
                {error && (
                    <div role="alert" className="bg-rose-50 dark:bg-rose-950/60 text-rose-700 dark:text-rose-300 px-5 py-4 rounded-2xl border border-rose-200 dark:border-rose-900/40 text-sm flex items-center justify-between font-medium">
                        <span>{error}</span>
                        <button onClick={() => { loadSession(); loadQueues(true); }} className="underline font-bold hover:text-rose-900 dark:hover:text-rose-200 transition-colors">Retry</button>
                    </div>
                )}
                ...
                <div className={`transition-opacity duration-200 ${isBackgroundLoading ? "opacity-60 pointer-events-none" : "opacity-100"}`}>
                    {queues.length === 0 ? (
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-2xl border-2 border-dashed border-slate-200 dark:border-white/10 text-center py-24 px-8">
                            ...
                            <h3 className="text-xl font-black text-slate-900 dark:text-white mb-2">No queues in this session</h3>
