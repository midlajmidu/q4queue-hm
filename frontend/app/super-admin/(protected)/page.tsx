...
function StatsCards({ stats, analytics, loading }: { stats: OrgStats | null; analytics: PlatformAnalytics | null; loading: boolean }) {
    const cards = [
        { label: "Total Orgs", value: stats?.total_parent_orgs, color: "blue", icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
        ...
        { label: "Entries Month", value: analytics?.total_queue_entries_month, color: "indigo", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
