...
import { ArrowRight, Eye, EyeOff, KeyRound, ArrowLeft, Mail, CheckCircle2 } from "lucide-react";
                            ...
                            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                                ...
                                <form onSubmit={handleRequestOtp} className="space-y-4" noValidate>
                                    ...
                                    <button
                                        ...
                                        className="w-full h-[44px] mt-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-[14px] rounded-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                                    >
                            ...
                            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                                ...
                                <form onSubmit={handleResetPassword} className="space-y-4" noValidate>
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative">
                                            ...
                                            <button
                                                ...
                                                className="absolute right-2 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 focus:outline-none p-1.5 rounded-md"
                                            >
                                    ...
                                    <button
                                        ...
                                        className="w-full h-[44px] mt-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-[14px] rounded-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                                    >
